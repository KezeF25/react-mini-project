...
function User({id, email, first_name, last_name, avatar, isInvited, onClickInvates}){
  return (
    <li>
      <div>
      ...
      <img onClick={() => onClickInvates(id)} className="action" src={`/assets/${!isInvited ? 'plus' : 'minus'}.svg`} alt="Action" />
    </li>
  );
};
